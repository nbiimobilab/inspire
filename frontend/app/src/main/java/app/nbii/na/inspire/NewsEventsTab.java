...
public class NewsEventsTab extends ActionBarActivity implements
        TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener  {

    private TabHost mTabHost;
    private ViewPager mViewPager;
    private HashMap<String, TabInfo> mapTabInfo = new HashMap<String, NewsEventsTab.TabInfo>();
    ...
    private void initialiseTabHost(Bundle args) {
        ...
        NewsEventsTab.AddTab(this, this.mTabHost,
                this.mTabHost.newTabSpec("News").setIndicator("News"),
                (tabInfo = new TabInfo("News", NewsFragment.class, args)));
        this.mapTabInfo.put(tabInfo.tag, tabInfo);
        NewsEventsTab.AddTab(this, this.mTabHost,
                this.mTabHost.newTabSpec("Events").setIndicator("Events"),
...
*/
     ...
     * @param tabSpec
     */
    private static void AddTab(NewsEventsTab activity, TabHost tabHost,
